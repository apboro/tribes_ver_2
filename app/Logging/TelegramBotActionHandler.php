...
class TelegramBotActionHandler extends AbstractProcessingHandler
{
    ...
    const BASE_ON_CHAT = 'Команда /database отправлена в группу';
    ...
    const SEND_BASE_IN_CHAT = 'Отправлена команда /database в чат группы';
    ...
    const ALL_EVENTS_ARRAY = [
        ...
        'Команда /database отправлена в группу',
        'Узнать Telegram ID',
        'Узнать ID чата',
        ...
        'Отправлена команда /database в чат группы',
