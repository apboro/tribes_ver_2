...
class Kernel extends ConsoleKernel
{
    ...
    protected function schedule(Schedule $schedule)
    {
        ...
        $schedule->command('get:messages')->everyMinute()->timezone('Europe/Moscow');
        $schedule->command('get:reactions')->everyMinute()->timezone('Europe/Moscow');
        $schedule->command('get:views')->everyMinute()->timezone('Europe/Moscow');
