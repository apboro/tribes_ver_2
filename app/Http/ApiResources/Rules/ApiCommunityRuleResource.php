...
class ApiCommunityRuleResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        return [
            ...
            'content_image_path' => $this->resource->content_image_path,
            'warning' => $this->resource->warning,
            'max_violation_times' => $this->resource->max_violation_times,
            'action' => $this->resource->action,
            'warning_image_path' => $this->resource->warning_image_path,
            'user_complaint_image_path' => $this->resource->user_complaint_image_path,
            'communities' => $this->resource->communities->pluck('id'),
