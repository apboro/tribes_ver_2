...
class ApiBanListDeleteRequest extends ApiRequest
{
    /**
     * @OA\POST(
     *  path="/api/v3/user/ban-list/delete",
     *  operationId="delete-from-ban-list",
     *  summary="Delete telegram user-community connection from ban list",
     *  security={{"sanctum": {} }},
     *  tags={"Ban list"},
     *     @OA\RequestBody(
     *         @OA\MediaType(
