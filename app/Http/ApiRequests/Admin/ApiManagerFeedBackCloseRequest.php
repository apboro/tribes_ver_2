...
/**
 * @OA\Get(
 *     path="/api/v3/manager/feed-back/close/{id}",
 *     operationId="admin-feed-back-close",
 *     summary="Close feed back from site",
 *     security={{"sanctum": {} }},
 *     tags={"Admin feed back"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 *         description="ID of feedback in database",
 *         required=true,
 *         @OA\Schema(
 *             type="integer",
 *             format="int64",
 ...
 * )
 */
class ApiManagerFeedBackCloseRequest extends ApiRequest
{
