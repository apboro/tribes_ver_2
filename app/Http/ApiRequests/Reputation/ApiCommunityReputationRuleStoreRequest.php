 ...
 *                 @OA\Property(property="delay_start_rules_time",type="date-time"),
 ...
 *                 @OA\Property(property="show_rating_tables_time",type="date-time"),
