...
class ApiWhiteListDeleteRequest extends ApiRequest
{
    /**
     * @OA\POST(
     *  path="/api/v3/user/white-list/delete",
     *  operationId="delete-from-white-list",
     *  summary="Delete telegram user-community connection from white list",
     *  security={{"sanctum": {} }},
     *  tags={"White list"},
     *     @OA\RequestBody(
     *         @OA\MediaType(
