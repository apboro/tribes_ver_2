...
class ApiConfirmPhoneTest extends TestCase
{
    ...
    private $url = 'api/v3/phone/confirm';
    private $data = [
        'not_auth' => [
            'expected_status' => 401,
            'expected_structure' => [
    ...
    public function test_not_auth(){
        ...
        $response->assertStatus($this->data['not_auth']['expected_status'])
    ...
    public function test_not_valid_code(){
        ...
        $response->assertStatus($this->data['not_valid']['expected_status'])
    ...
    public function test_sms_is_blocked(){
        ...
        $response->assertStatus($this->data['sms_is_blocked']['expected_status'])
    ...
    public function test_sms_error_code(){
        ...
        $response->assertStatus($this->data['error_code']['expected_status'])
