...
class ApiTelegramUserBanListTest extends TestCase
{
    private $url = [
        'add_ban_list' => 'api/v3/user/ban-list/add',
        'delete_from_ban_list' => 'api/v3/user/ban-list/delete',
    ];
    ...
    public function test_ban_list_not_auth()
    {
        $response = $this->withHeaders([
            'Accept' => 'application/json',
        ])->post($this->url['add_ban_list']);
    ...
    public function test_ban_list_store_empty_data()
    {
    ...
    public function test_ban_list_store_not_valid_telegram_id()
    {
        ...
        $response = $this->withHeaders([
            'Accept' => 'application/json',
            'Authorization' => 'Bearer ' . $this->custom_token,
        ])->post($this->url['add_ban_list'], $this->data['not_valid_data']);

        $response->assertStatus($this->data['not_valid_data']['expected_status'])
            ->assertJsonStructure($this->data['not_valid_data']['expected_structure']);
    }

    public function test_ban_list_store_not_valid_community_ids()
    {
    ...
    public function test_ban_list_store_success()
    {
    ...
    public function test_ban_list_delete_not_auth()
    {
        $response = $this->withHeaders([
            'Accept' => 'application/json',
        ])->post($this->url['delete_from_ban_list']);
    ...
    public function test_ban_list_delete_empty_data()
    {
    ...
    public function test_ban_list_delete_not_valid_telegram_id()
    {
        ...
        $response = $this->withHeaders([
            'Accept' => 'application/json',
            'Authorization' => 'Bearer ' . $this->custom_token,
        ])->post($this->url['delete_from_ban_list'], $this->data['not_valid_data']);

        $response->assertStatus($this->data['not_valid_data']['expected_status'])
            ->assertJsonStructure($this->data['not_valid_data']['expected_structure']);
    }

    public function test_ban_list_delete_not_valid_community_ids()
    {
    ...
    public function test_ban_list_delete_success()
    {
        ...
        $this->data['create_success']['telegram_id'] = $this->custom_user->telegramData()[0]->telegram_id;
        $this->data['create_success']['community_ids'] = [$this->custom_community->id];

        $response = $this->withHeaders([
            'Accept' => 'application/json',
            'Authorization' => 'Bearer ' . $this->custom_token,
        ])->post($this->url['delete_from_ban_list'], $this->data['create_success']);
