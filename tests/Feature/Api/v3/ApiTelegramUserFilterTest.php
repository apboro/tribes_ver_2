...
class ApiTelegramUserFilterTest extends TestCase
{
    use WithFaker;
    ...
    public function test_black_list_filter_not_auth()
    {
        $response = $this->withHeaders([
            'Accept' => 'application/json',
        ])->post($this->url['filter_black_list']);
    ...
    public function test_black_list_filter_not_valid_is_spammer()
    {
    ...
    public function test_black_list_filter_is_spammer_success()
    {

        $this->data['filter_success']['is_spammer'] = 1;
        $response = $this->withHeaders([
            'Accept' => 'application/json',
            'Authorization' => 'Bearer ' . $this->custom_token,
        ])->post($this->url['filter_black_list'], $this->data['filter_success']);
    ...
    public function test_black_list_filter_user_name_success()
    {
    ...
    public function test_black_list_filter_community_id()
    {
        $this->setUp();
