...
class ApiProjectTest extends TestCase
{
    ...
    private $url = [
        ...
        'create_project'=>'api/v3/projects',
    ...
    public function test_create_project_title_data(){
        ...
        $response->assertStatus($this->data['title_data']['expected_status'])
    ...
    public function test_show_project(){
        ...
        $response->assertStatus($this->data['show_project']['expected_status'])
    ...
    public function test_show_project_error_type(){
        ...
        $response->assertStatus($this->data['show_project_error_type']['expected_status'])
    ...
    public function test_show_project_not_found(){
        ...
        $response->assertStatus($this->data['show_project_not_found']['expected_status'])
    ...
    public function test_update_project_empty_id(){
        $response =  $this->withHeaders([
            'Accept'=>'application/json',
            'Authorization' => 'Bearer ' . $this->custom_token
        ])->put($this->url['update_project'].'/'.$this->data['update_empty_id']['id']);
        $response->assertStatus($this->data['update_empty_id']['expected_status'])
    ...
    public function test_update_project_not_valid_id(){
        $response =  $this->withHeaders([
            'Accept'=>'application/json',
            'Authorization' => 'Bearer ' . $this->custom_token
        ])->put($this->url['update_project'].'/'.$this->data['update_not_valid_id']['id']);
        $response->assertStatus($this->data['update_not_valid_id']['expected_status'])
    ...
    public function test_update_project_empty_title(){
        ...
        $response =  $this->withHeaders([
            'Accept'=>'application/json',
            'Authorization' => 'Bearer ' . $this->custom_token
        ])->put($this->url['update_project'].'/'.$project->id,$this->data['update_empty_title']);
        $response->assertStatus($this->data['update_empty_title']['expected_status'])
    ...
    public function test_update_project_not_valid_title(){
        ...
        $response =  $this->withHeaders([
            'Accept'=>'application/json',
            'Authorization' => 'Bearer ' . $this->custom_token
        ])->put($this->url['update_project'].'/'.$project->id,$this->data['update_not_valid_title']);
        $response->assertStatus($this->data['update_not_valid_title']['expected_status'])
    ...
    public function test_update_project_project_not_exist(){
        $response =  $this->withHeaders([
            'Accept'=>'application/json',
            'Authorization' => 'Bearer ' . $this->custom_token
        ])->put($this->url['update_project'].'/'.$this->data['update_project_not_exist']['id'],$this->data['update_project_not_exist']);
        $response->assertStatus($this->data['update_project_not_exist']['expected_status'])
    ...
    public function test_update_project_success(){
        ...
        $response =  $this->withHeaders([
            'Accept'=>'application/json',
            'Authorization' => 'Bearer ' . $this->custom_token
        ])->put($this->url['update_project'].'/'.$project->id,$this->data['update_success']);
        $after_update = Project::where('id','=',$project->id)->first();

        $this->assertEquals($after_update->title,$this->data['update_success']['title']);

        $response->assertStatus($this->data['update_success']['expected_status'])
    ...
    public function test_update_project_error(){
        ...
        $response =  $this->withHeaders([
            'Accept'=>'application/json',
            'Authorization' => 'Bearer ' . $this->custom_token
        ])->put($this->url['update_project'].'/'.$project->id,$this->data['update_project_error']);
        ...
        $response->assertStatus($this->data['update_project_error']['expected_status'])
    ...
    public function test_projects_success(){
        ...
        $response->assertStatus($this->data['show_user_projects_success']['expected_status'])
