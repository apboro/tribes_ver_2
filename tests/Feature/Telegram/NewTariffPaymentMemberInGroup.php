...
class NewTariffPaymentMemberInGroup extends TestCase
{
    /**
...
');
    ...
    (13,	5,	"standart test",	1,	365,	"t",	"2022-08-12 09:49:05",	"2022-08-12 09:49:05",	NULL);
');
        DB::insert('NSERT INTO "telegram_users_tarif_variants" ("tarif_variants_id", "telegram_user_id", "days", "prompt_time", "created_at", "updated_at", "isAutoPay") VALUES
    (13,	5,	365,	"10:05",	"2022-08-12 10:05:10",	NULL,	"t");
');
