...
namespace Tests\old_test\Unit\filters;
...
class QueryAPIFilterTest extends TestCase
{
    ...
    {
        parent::setUp();
        $this->filter = app()->make(\Tests\Unit\filters\TestFilter::class);
    ...
    public function testFilterCaptureAttributesFromRequest()
    {
        ...
        $filter = app()->make(\Tests\Unit\filters\TestFilter::class, ['request' => $request]);
