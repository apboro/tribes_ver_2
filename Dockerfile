...
RUN apk --no-cache add php-pgsql postgresql14-dev pcre-dev libjpeg-turbo-dev libpng-dev php7-imagick libzip-dev freetype-dev php7-bcmath php7-curl $PHPIZE_DEPS \
  && pecl install redis \
