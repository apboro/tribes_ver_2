<template>
    <div class="lesson-settings" >
        ...
        <div class="lesson-settings__published">
            ...
            <label for="published" class="lesson-settings__published-label">Опубликовано</label>
        </div>
                    ...
                    <div class="modal__wrapper">
                        <div class="modal__container">
                            ...
                            <div class="modal__footer">
                                <slot name="footer">
                                    <button class="button button--danger modal__footer-item" @click="removeLesson(lesson.id)">Удалить</button>
                                    <button class="button-outline button-outline--success modal__footer-item" @click="showModal=false">Отмена</button>
                                </slot>
                            </div>
                        </div>
                    </div>
