<template>
    <i class="icon">
        ...
        <template v-if="name == 'vertical-dots'">
            <svg :width="width" :height="height" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <template v-if="name == 'spinner-primary'">
        ...
        <template v-if="name == 'info'">
            <svg :width="width" :height="height" viewBox="0 0 231 231" fill="none" xmlns="http://www.w3.org/2000/svg">
                <circle cx="115.5" cy="115.5" r="109.5" stroke="#7367F0" stroke-opacity="0.15" stroke-width="12"/>
                <path d="M99.5925 35H133.263L127.575 141.574H105.052L99.5925 35ZM116.428 196C111.119 196 106.721 194.33 103.232 190.99C99.7442 187.498 98 183.248 98 178.238C98 173.228 99.7442 169.053 103.232 165.713C106.721 162.373 111.119 160.703 116.428 160.703C121.584 160.703 125.831 162.373 129.168 165.713C132.656 169.053 134.4 173.228 134.4 178.238C134.4 183.248 132.656 187.498 129.168 190.99C125.831 194.33 121.584 196 116.428 196Z" fill="#7367F0" fill-opacity="0.15"/>
            </svg>
        </template>
        ...
        <template v-if="name == 'right-arrow'">
