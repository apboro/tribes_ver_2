    ...
    <div class="page page-center">
        <div class="container-tight py-4">
            ...
            <form class="card card-md" action="." method="get" autocomplete="off">
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" class="form-control" placeholder="Введите email" autocomplete="off">
                    </div>
                    <div class="mb-2">
                  ...
                  <a href="#">Забыли пароль?</a>
                        ...
                        <div class="input-group input-group-flat">
                            <input type="password" class="form-control"  placeholder="Введите пароль"  autocomplete="off">
            ...
            <div class="text-center text-muted mt-3">
                У вас еще нет аккаунта? <a href="#" tabindex="-1">Зарегистрироваться</a>
            </div>
        </div>
    </div>
</template>
