  ...
  <div class="card">
      ...
      <div class="d-flex align-items-center justify-content-between">
        <div class="text-muted">
          ...
          <div class="mx-2 d-inline-block">
            <input type="text" class="form-control" :value="this.filter_data.filter.entries" @input="changePageEntries"
                   size="3">
          </div>
          на странице
        </div>
    ...
    <div class="table-responsive">
          ...
          <th>Название
            ...
            >
              <template v-if="sortRuleOnTitle == 'off'">
                <svg style="margin: 0;" width="16" height="32" viewBox="0 0 16 32" fill="none"
                     xmlns="http://www.w3.org/2000/svg" class="icon text-dark icon-thick">
                  <path
                      d="M12.4654 21.5337C12.332 21.4003 12.1987 21.3337 11.9987 21.3337C11.7987 21.3337 11.6654 21.4003 11.532 21.5337L7.9987 25.067L4.46536 21.5337C4.1987 21.267 3.7987 21.267 3.53203 21.5337C3.26536 21.8003 3.26536 22.2003 3.53203 22.467L7.53203 26.467C7.7987 26.7337 8.1987 26.7337 8.46536 26.467L12.4654 22.467C12.732 22.2003 12.732 21.8003 12.4654 21.5337Z"
                      fill="#363440"/>
                  <path
                      d="M12.4654 10.4663C12.332 10.5997 12.1987 10.6663 11.9987 10.6663C11.7987 10.6663 11.6654 10.5997 11.532 10.4663L7.9987 6.93301L4.46536 10.4663C4.1987 10.733 3.7987 10.733 3.53203 10.4663C3.26536 10.1997 3.26536 9.79967 3.53203 9.53301L7.53203 5.53301C7.7987 5.26634 8.1987 5.26634 8.46536 5.53301L12.4654 9.53301C12.732 9.79967 12.732 10.1997 12.4654 10.4663Z"
                      fill="#363440"/>
                </svg>
              </template>
      ...
      <div class="card-footer d-flex align-items-center">
        <ul v-if="communities.meta" class="pagination m-0 ms-auto">
          <li
    ...
    sortBy(name) {
      ...
      if (this.sortName == 'date') {
        switch (this.sortRuleOnDate) {
          case 'off':
            this.sortRuleOnDate = 'asc';
            break;
          case 'asc':
            this.sortRuleOnDate = 'desc';
            break;
          case 'desc':
            this.sortRuleOnDate = 'off';
            break;
        }
      ...
      if (this.sortName == 'balance') {
        switch (this.sortRuleOnBalance) {
          case 'off':
            this.sortRuleOnBalance = 'asc';
            break;
          case 'asc':
            this.sortRuleOnBalance = 'desc';
            break;
          case 'desc':
            this.sortRuleOnBalance = 'off';
            break;
        }
      ...
      if (this.sortName == 'title') {
        switch (this.sortRuleOnTitle) {
          case 'off':
            this.sortRuleOnTitle = 'asc';
            break;
          case 'asc':
            this.sortRuleOnTitle = 'desc';
            break;
          case 'desc':
            this.sortRuleOnTitle = 'off';
            break;
        }
      ...
      if (this.sortName == 'followers') {
        switch (this.sortRuleOnFollowers) {
          case 'off':
            this.sortRuleOnFollowers = 'asc';
            break;
          case 'asc':
            this.sortRuleOnFollowers = 'desc';
            break;
          case 'desc':
            this.sortRuleOnFollowers = 'off';
            break;
        }
