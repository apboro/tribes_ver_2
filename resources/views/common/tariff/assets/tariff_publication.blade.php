<div class="settings-text-image community-settings__text-image">
    ...
    <!-- Изображение -->
    <div class="settings-text-image__image-block" data-crop-image-container="publication">
        <label class="form-label-red">
            {{ __('base.image') }}
        </label>

        <div class="settings-text-image__image" data-crop-image-container="publication">
            <div class="settings-text-image__image-message hide" data-image-alert></div>
            ...
            <div class="settings-text-image__load-container @if($community->tariff &&  $community->tariff->getPublicationImage()) hide @else  @endif" data-crop-image-load-container>
                    <!-- Описание загрузки -->
                    <div
                    ...
                    <div class="settings-text-image__cropper  cropper">
                        <div class="settings-text-image__cropper-container" data-crop-image-croppr-container></div>
                    </div>
                
            </div>

            <!-- Кнопки -->
            <div class="settings-text-image__buttons @if($community->tariff && $community->tariff->getPublicationImage()) @else hide @endif" data-crop-image-buttons-container>                
                <label
