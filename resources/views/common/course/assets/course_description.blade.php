    ...
    <div class="row">
        ...
        <div class="col-md-12 col-lg-6">
            <div class="mb-1 mb-lg-0">
                ...
                <textarea
                    ...
                    name="description"
                    rows="5"
                    placeholder="Текстовое описание курса"
                ></textarea>
        ...
        <div class="col-md-12 col-lg-6">
            ...
            <div class="d-flex flex-column align-items-center" data-crop-image-container="description">
                <div class="col-12 message-alert hide" data-image-alert></div>

                <!-- Если есть загруженное изображение -->
                <div
                    class="col-12 d-flex flex-column position-relative active-image @if(1 == 0) d-block @else d-none @endif"
                ...
                <div class="d-flex flex-column align-items-center w-100 text-center @if(1 == 0) hide @else  @endif" data-crop-image-load-container>
                ...
                <!-- Кнопки -->
                <div class="col-12 d-flex mt-1 @if(1 == 0) @else hide @endif" data-crop-image-buttons-container>
