        ...
        <div class="row">
            <div class="col-12">
                                    ...
                                    <form action="" method="get">
                                        ...
                                        <div class="row mt-1">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                @if($activeCommunity->tariffVariants->isNotEmpty())
                                                <select name="filter[tariff]" class="form-select pointer" id="basicSelect">
                                                    <option value="" @if (request('filter.tariff') == null) selected @endif>
                                                        {{ __('base.all') }}</option>
                                                    @foreach ($activeCommunity->tariffVariants as $variant)
                ...
                ['filter[sort][name]' => 'accession_date', 'filter[sort][rule]' => request('filter.sort.rule') === 'asc' ? 'desc' : 'asc']
                                    ...
                                    <!-- TABLE -->
                                    <form action="{{ route('community.tariff.subscriptionsChange', $activeCommunity) }}" method="POST">
                                                        ...
                                                        @foreach ($followers as $follower)
                                                            <tr class="odd">
                                                                ...
                                                                <td valign="top" colspan="1" class="dataTables_empty">
                                                                    ...
                                                                    >
                                                                        @if ($activeCommunity->tariff !== null)
                                                                            <option value="{{ false }}"
                                                                ...
                                                                <td valign="top" colspan="1" class="dataTables_empty">
                                                                    <div class="col-sm-12 col-lg-12">
                                                                        {{ $follower->getTariffById($activeCommunity->tariff->id) ? $follower->getTariffById($activeCommunity->tariff->id)->pivot->days : '—' }}
                                                                                ...
                                                                                <div class="d-flex align-items-center">
                                                                                    <div
                                                                                        ...
                                                                                        <input type="checkbox"
                                                                                               ...
                                                                                               value="true"
                                                                                               name="excluded[{{ $follower->id }}]"
                                                                                        @if ($follower->getCommunityById($activeCommunity->id)) {{ $follower->getCommunityById($activeCommunity->id)->pivot->excluded == true ? 'checked' : null }} @endif />
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
