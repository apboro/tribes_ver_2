...
@section('content')
            ...
            <ul class="analytics-community__card-list">
                <li class="card-analytics-community analytics-community__card-item">
                    ...
                    <div class="card-analytics-community__footer">
                        ...
                        <a
                                href="{{ route('project.analytics.subscribers', array_filter([ 'project' => $project??'c', 'community'=> $community])) }}"
                ...
                <li class="card-analytics-community analytics-community__card-item">
                    ...
                    <div class="card-analytics-community__footer">
                        ...
                        <a
                                href="{{ route('project.analytics.messages', array_filter([ 'project' => $project??'c', 'community'=> $community])) }}"
                                class="button-filled button-filled--primary card-analytics-community__link"
                        >
                            Подробнее
                        </a>
                ...
                <li class="card-analytics-community analytics-community__card-item">
                    ...
                    <div class="card-analytics-community__footer">
                        ...
                        <a
                                href="{{ route('project.analytics.payments', array_filter([ 'project' => $project??'c', 'community'=> $community])) }}"
                                class="button-filled button-filled--primary card-analytics-community__link"
                        >
                            Подробнее
                        </a>
    ...
    <div class="profile__list communities">
        <div class="profile__community_not_selected">
            <p>Для работы с аналитикой выберите конкретное сообщество в проекте.</p>
        </div>
    </div>
    @endif
@endsection