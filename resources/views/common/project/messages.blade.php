    ...
    >
        <div class="analytics-community__analytics-wrap">
            <div class="analytics-community__title-wrap">
                <a
                        href="{{ route('project.analytics', array_filter([ 'project' => $project??'c', 'community'=> $community])) }}"
                        class="button-back"
                >
            ...
            <div>
                ...
                >
                    <option value="{{ route('project.analytics.subscribers', array_filter([ 'project' => $project??'c', 'community'=> $community])) }}">Подписчики</option>
                    <option value="{{ route('project.analytics.messages', array_filter([ 'project' => $project??'c', 'community'=> $community])) }}" selected>Сообщения</option>
