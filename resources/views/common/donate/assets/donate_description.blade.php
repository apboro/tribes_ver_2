<div class="settings-text-image community-settings__item">
    ...
    <div class="settings-text-image__text">
        <label
            ...
            for="donate_description_text"
        >
            {{ __('donate.donate_description') }} *
        </label>

        <textarea
            class="form-control-red @error('description') form-control-red--danger @enderror"
    ...
    <div
        ...
        data-crop-image-container="main"
    >
        ...
        >
            ...
            <div
                class="settings-text-image__active-image @if($donate && $donate->getMainImage()) d-block @else d-none @endif"
            ...
            <div
                class="settings-text-image__load-container @if($donate && $donate->getMainImage()) hide @else  @endif"
            ...
            <!-- Кнопки -->
            <div
                class="settings-text-image__buttons @if($donate && $donate->getMainImage()) @else hide @endif"
