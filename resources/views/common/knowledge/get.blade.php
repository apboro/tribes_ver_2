        ...
        <section class="breadcrumbs">
            <div class="container">
                <ul class="breadcrumbs__list">
                    ...
                    <li class="breadcrumbs__item">
                        <a href="{{ $question->getPublicQuestionsLink() }}" class="breadcrumbs__link">
                            {{ $community -> title }}
                        </a>
                    </li>
            ...
            <div class="container">
                <div class="knowledge-list__col-first">
                    ...
                    <a
                        ...
                        class="knowledge-list__list-link"
                    >
                    ...
                    <li class="knowledge-list__item active">
                        ...
                        <div class="knowledge-list__answer">
                            <div>
                                ...
                                <span><noindex>Ответ отсутствует</noindex></span>
                                @else
                                <span><noindex>{!! $question->answer->context !!}</noindex></span>
                                @endif
                                <i class="knowledge-list__help-icon">
                                    <svg width="35" height="35" viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg">
