<div class="dropdown-project-list-m">
    <button class="dropdown-project-list-m__header" data-dropdown-btn onclick="Dropdown.toggle(this)">
        <span class="dropdown-project-list-m__title">
            {{ $activeProject->title ?? $activeCommunity->title ?? 'Без имени' }}
        </span>

        <i class="dropdown-project-list-m__arrow">
    ...
    <div class="dropdown-project-list-m__body" data-dropdown-content>
        <div class="dropdown-project-list-m__scroll">
            <h6 class="dropdown-project-list-m__category">
                Проекты
            </h6>

            <ul class="dropdown-project-list-m__project-list">
            ...
            <ul class="dropdown-project-list-m__community-list">
    ...
    <div class="dropdown-project-list-m__overlay"></div>
</div>
