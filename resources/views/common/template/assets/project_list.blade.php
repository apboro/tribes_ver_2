        ...
        <div class="dropdown-project-list__scroll">
                ...
                <li class="dropdown-project-list__project-item">
                    <div class="dropdown-project-list__project-link active">
                        <div class="dropdown-project-list__project-link-active-wrapper">
                            <p class="dropdown-project-list__project-link-title">project 112131232131 df  df dfdd df df21</p>
                            <p class="dropdown-project-list__project-link-subtitle">Сообществ: 10</p>
                        </div>
                        <a
                            href=""
            ...
            <ul class="dropdown-project-list__community-list">
                <li class="dropdown-project-list__community-item">
                    <a href="" class="dropdown-project-list__community-link">
                        ...
                        <div class="dropdown-project-list__project-link-active-wrapper">
                            <p class="dropdown-project-list__community-link-title">
                                Das Herz g gfg fg fgfg ffg fg g fgfg f
                            </p>
                ...
                <li class="dropdown-project-list__community-item">
                    <div class="dropdown-project-list__community-link active">
                        <div class="dropdown-project-list__community-link-avatar">
                            <img src="/images/no-user-avatar.svg" alt="">
                        </div>
                        ...
                        <div class="dropdown-project-list__project-link-active-wrapper">
                            <p class="dropdown-project-list__community-link-title">
                                Das Herz fd d dfd fd dfd f d ddf df
                            </p>
