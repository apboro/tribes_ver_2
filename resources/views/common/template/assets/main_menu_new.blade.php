<nav class="main-nav-new main-header-red__main-nav">
    <ul class="main-nav-new__list">
        ...
        <li class="main-nav-red__item">
            <div class="dropdown-lk main-nav-new__dropdown">
                <button class="dropdown-lk__head main-nav-new__link" data-dropdown-btn onclick="Dropdown.toggle(this)">
                    <span class="dropdown-lk__name main-nav-new__link">
                        Монетизация
                    </span>
                ...
                <ul class="dropdown-lk__list" data-dropdown-content>
                    <li class="dropdown-lk__item">
                        <a class="dropdown-lk__link" href="">
                            <span>Донаты</span>
                        </a>
                    </li>
