                            ...
                            >
                                ...
                                >
                                    ...
                                    <tr>
                                        ...
                                        @endif
                                        <p style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0; margin-bottom: 24px;">
                                            Оплата по тарифу {{$tariff_variant_name }} в сообществе {{$community_name}}
                                            не удалась. Доступ в сообщество закрыт.
                                        </p>
                                        </td>
                                    </tr>
                                    Если мы не решили Ваш вопрос, отправьте, пожалуйста, повторное обращение или
                                    свяжитесь с нашими специалистами в Telegram.
                                    <br>
