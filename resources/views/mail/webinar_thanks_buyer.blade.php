...
<head>
  ...
  <![endif]-->
    <title>Доступ к вебинару успешно оплачен</title>
                                    ...
                                    <tr>
                                        ...
                                        >
                                            ...
                                            <p style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0; margin-bottom: 24px;">
                                                Вы только что купили <a href="{{ config('app.frontend_url') }}/courses/member/webinar-preview/{{ $webinar->uuid }}">{{ $webinar->title }}</a>. {{ env('APP_NAME') }} всегда с вами =)
