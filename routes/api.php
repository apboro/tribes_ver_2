...
Route::prefix('api/v3')->group(function () {
    ...
    Route::match(array('GET', 'POST'), '/safe-route/widget/api/{shop_id}',[
        SafeRouteController::class, 'getWidget'
    ])->name('safe.route.widget.api');
    ...
    Route::get('/public/product/{id}', [ApiProductController::class, 'publicShow'])->name('api.products.show_by_uuid');
    Route::get('/public/product-history/{shopId}', [ApiProductHistoryController::class, 'list'])->name('api.products.history.list');
    ...
    Route::get('/market/show/orders/history', [MarketController::class, 'shopOrdersHistory'])->name('market.orders.history');
...
Route::prefix('api/v3')->middleware(['api', 'auth_v3:sanctum'])->group(function () {
    ...
    Route::post('/product/change/status/{id}', [ApiProductController::class, 'changeStatus'])->name('api.products.changeStatus');
